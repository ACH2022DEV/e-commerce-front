...
const routes: Routes = [
  ...
  { path: 'visualiser-personne', component: VisualiserPersonneComponent, canActivate: [GuardService] },
  ...
  { path: 'visualiser-produits', component: VisualiserProduitsComponent, canActivate: [GuardService] },
  { path: 'crer-produits', component:  CrerProduitsComponent, canActivate: [GuardService] },
  { path: 'editer-produits', component:  EditerProduitsComponent, canActivate: [GuardService] },
  { path: 'liste-facture', component: FactureComponent, canActivate: [GuardService] },
  { path: 'editer-facture', component: EditerFactureComponent, canActivate: [GuardService] },
  { path: 'crer-facture', component: CrreFactureComponent, canActivate: [GuardService] },
  { path: 'visualiser-facture', component: VisualiserFactureComponent, canActivate: [GuardService] },

  { path: 'liste-devis', component: ListeDeisComponent, canActivate: [GuardService] },
  { path: 'editer-devis', component: EditerDevisComponent, canActivate: [GuardService] },
  { path: 'crer-devis', component: CrerDevisComponent, canActivate: [GuardService] },
  { path: 'visualiser-devis', component: VisualiserDevisComponent, canActivate: [GuardService] },
